...
export default function App() {
  ...
  return (
    <div className="App">
      <h1><img className="title" src="https://fontmeme.com/permalink/200306/272f5270876666e7e43302429482f942.png" alt="game-of-thrones-font" border="0"></img></h1>
      ...
      <div>
        <Route exact path="/">
          <Grid container direction="row" justify="center" className="genre-list" spacing={3}>
